...
class StorageConfig(BASE, DbBase):
    ...
    endpoint = Column(String(512), default='http://82.156.225.136:9000', comment='S3 端点地址')
    access_key = Column(String(256), default='admin', comment='AccessKey ID')
    secret_key = Column(String(256), default='password123', comment='AccessKey Secret')
